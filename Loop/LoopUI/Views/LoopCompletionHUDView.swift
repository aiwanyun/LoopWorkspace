    ...
    public var loopCompletionMessage: (title: String, message: String) {
        ...
        case .fresh:
            if loopStateView.open {
                ...
                return (title: LocalizedString("关闭闭环", comment: "Title of green open loop OFF message"),
        ...
        case .aging:
            return (title: LocalizedString("闭环警告", comment: "Title of yellow loop message"),
        ...
        case .stale:
            return (title: LocalizedString("闭环故障", comment: "Title of red loop message"),
