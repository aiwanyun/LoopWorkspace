...
extension LoopDataManager: ServicesManagerDelegate {
    ...
    enum CarbActionError: LocalizedError {
        ...
        var errorDescription: String? {
            switch  self {
            case .exceedsMaxCarbs:
                return NSLocalizedString("超过最大允许的碳水化合物", comment: "Carb error description: carbs exceed maximum amount.")
            case .invalidCarbs:
                return NSLocalizedString("无效的碳水化合物量", comment: "Carb error description: invalid carb amount.")
