    ...
    static func alertIfNeeded(viewControllerToPresentFrom: UIViewController) {
        ...
        if isTestFlightBuild() {
            dialog = UIAlertController(
                title: NSLocalizedString("Testflight即将到期", comment: "The title for notification of upcoming TestFlight expiration"),
                message: alertMessage,
                preferredStyle: .alert)
            dialog.addAction(UIAlertAction(title: NSLocalizedString("好的", comment: "Text for ok action on notification of upcoming TestFlight expiration"), style: .default, handler: nil))
            dialog.addAction(UIAlertAction(title: NSLocalizedString("更多信息", comment: "Text for more info action on notification of upcoming TestFlight expiration"), style: .default, handler: { (_) in
