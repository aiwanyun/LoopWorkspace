    ...
    private func alert(for alert: AddEditFavoriteFoodViewModel.Alert) -> SwiftUI.Alert {
        ...
        case .warningQuantityValidation:
            ...
            return SwiftUI.Alert(
                ...
                secondaryButton: .cancel(Text("是的", comment: "The title of the action used when confirming entered amount of carbohydrates."), action: viewModel.clearAlertAndSave)
            )
        }
    }
}
