...
public struct IntegralRetrospectiveCorrectionSelectionView: View {
    ...
    public var body: some View {
        ScrollView {
            VStack(spacing: 10) {
                Text(NSLocalizedString("整体回顾性校正", comment: "Title for integral retrospective correction experiment description"))
                    .font(.headline)
                    .padding(.bottom, 20)
                ...
                Toggle(NSLocalizedString("启用整体回顾性校正", comment: "Title for Integral Retrospective Correction toggle"), isOn: $isIntegralRetrospectiveCorrectionEnabled)
